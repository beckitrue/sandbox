...
class GHAapp < Sinatra::Application
  ...
  post '/event_handler' do
    ...
    when 'issues'
      if @payload['action'] === 'opened' && @payload['issue']['title'] =~ /^(.*?(\baccess\b)[^$]*)$/
  ...
  helpers do
    ...
    def handle_issue_opened_event(payload)
      ...
      @installation_client.add_labels_to_an_issue(repo, issue_number, ['access-request'])
    end
